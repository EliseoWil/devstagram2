    ...
    <div class="container mx-auto md:flex">
        <div class="md:w-1/2">
            ...
            <div class="p-3 flex items-center gap-4">
                @auth
                {{-- @php
                    $mensaje = "Hola mundo desde variableeee";
                @endphp --}}
                <livewire:like-post :post="$post" />
                    {{-- PERSONA QUE AUN NO DIO LIKE --}}
            ...
            <div>
                ...
                <p class="text-sm text-gray-500">
                    {{ $post->created_at->diffForHumans() }} {{-- DE LA API CARBON DE FECHAS --}}
                </p>
        ...
        <div class="md:w-1/2 p-5">
            <div class="shadow bg-white p-5 mb-5">
                @auth
                    ...
                    {{-- PARA MOSTRAR EL MENSAJE ENVIADO DESDE EL CONTROLADOR --}}
                    @if (session('mensaje'))
